      ...
      <form id="email-form" name="email-form" data-name="Email Form" method="get">
        <div class="w-layout-grid f-account-input-grid">
          <label v-for="category in categories" v-bind:key="category.id" class="w-checkbox f-checkbox-field-2">
            <input :value="category.id" type="checkbox" v-model="selectedCategories" :true-value="category.id"
              :false-value="null" style="opacity:0;position:absolute;z-index:-1">
      ...
      <form id="email-form" name="email-form" data-name="Email Form" method="get">
        <div class="w-layout-grid f-account-input-grid">
          <label class="w-checkbox f-checkbox-field-2">
            <input type="checkbox" v-model="unclaimedOnly" name="Checkbox-2"
